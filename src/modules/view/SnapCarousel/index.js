...
import styles2, { sliderWidth, itemWidth } from './styles/SliderEntry.style';
...
export default class example extends Component {
  ...
  _renderItem2({ item, index }, parallaxProps) {
    return (
      <View style={styles2.slideInnerContainer}>
        <ParallaxImage
          source={{ uri: item.illustration }}
          containerStyle={styles2.imageContainer}
          style={[styles2.image, { borderColor: 'red', borderWidth: 5 }]}
          parallaxFactor={0.9}
          {...parallaxProps}
        />
        <Text style={styles2.title} numberOfLines={2}>
          {item.title}
        </Text>
      </View>
    );
